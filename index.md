...
venue: "Unseen University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "R'lyeh"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "nr"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1)
